...
public class AdminToolApplication extends Application {
    ...
    private void createServices() throws InternalClientException,
        EscidocException, TransportException, MalformedURLException {
    ...
    private OrgUnitTreeView createResourceTreeView() {
        ...
        try {
            ...
            orgUnitTreeView =
                new OrgUnitTreeView(mainWindow, header, resourceContainer);

            orgUnitTreeView.setCommand(new AddChildrenCommandImpl(
    ...
    private void createContentModelView() throws EscidocClientException {
        ...
        final ContentModelListView listView =
            new ContentModelListViewImpl(container,
                new ContentModelSelectListener(contentModelService, mainWindow));
        ...
        final DeleteContentModelListener deleteListener =
            new DeleteContentModelListener(
                (ContentModelService) contentModelService, container, this);

        final ContentModelEditView editView =
            new ContentModelEditView(contentModelService, mainWindow,
                pdpRequest, deleteListener);
        editView.init();

        contentModelView =
            new ContentModelViewImpl(listView, addView, editView, pdpRequest);
