...
class ResourceTypeListener implements ValueChangeListener {
    ...
    private void loadUserData() {
        ...
        roleView.resourceResult.setContainerDataSource(dataSource);
        roleView.resourceResult.setItemCaptionPropertyId(ViewConstants.X_LINK_TITLE);
    }
    ...
    private void loadGroupData() {
    	final POJOContainer<Resource> groupSource =
    			new POJOContainer<Resource>(Resource.class, ViewConstants.X_LINK_TITLE);
    	for (final Resource group: findAllGroups()) {
    		groupSource.addItem(group);
    	}
    	roleView.resourceResult.setContainerDataSource(groupSource);
    	roleView.resourceResult.setItemCaptionPropertyId(ViewConstants.X_LINK_TITLE);
    }
    
    private Collection<UserGroup> findAllGroups() {
    	try {
    		return roleView.groupService.findAll();
    	}
    	catch (final EscidocClientException e) {
    		handleError(e);
    	}
    ...
    private void loadItemData() {
        ...
        roleView.resourceResult.setContainerDataSource(itemContainer);
        roleView.resourceResult.setItemCaptionPropertyId(ViewConstants.X_LINK_TITLE);
    }
    ...
    private Component assignComponent() {
        ...
        newComponent = roleView.resourceResult;
        return newComponent;
    }
    ...
    private void configureList(final POJOContainer<Resource> contextContainer) {
        roleView.resourceResult.setContainerDataSource(contextContainer);
        roleView.resourceResult.setItemCaptionPropertyId(PropertyId.NAME);
    }
