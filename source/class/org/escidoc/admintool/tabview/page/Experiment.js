qx.Class.define("org.escidoc.admintool.tabview.page.Experiment",
{
  ...
  members : {
	...
	var msg = "Experiment[" +
	  ...
	  "id[" + container.getId() + "]" +
	  "workspace[" + container.getContextId() + "]" +
	  "eSyncDaemonUrl[" + container.getESyncDaemonUrl() + "]" +
	  "depostiServiceUrl[" + container.getDepositServiceUrl() + "]" +
	  "email[" + container.getEmail() + "]" +
	  "monitoredFolder[" + container.getMonitoredFolder() + "]" +
	  "contentModel[" + container.getContentModelId() + "]" +
