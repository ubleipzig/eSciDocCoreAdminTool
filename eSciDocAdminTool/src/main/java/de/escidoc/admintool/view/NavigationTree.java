...
public class NavigationTree extends Tree {
    ...
    public static final String ORGANIZATIONAL_UNIT =
        Messages.getString("NavigationTree.0"); //$NON-NLS-1$

    public static final String CONTEXT = Messages.getString("NavigationTree.1"); //$NON-NLS-1$

    public static final String USERS_LAB =
        Messages.getString("NavigationTree.2"); //$NON-NLS-1$

    public static final String ROLE = "Role";

    private final String[] MENU_ACTIONS =
        { ORGANIZATIONAL_UNIT, CONTEXT, USERS_LAB, ROLE };
