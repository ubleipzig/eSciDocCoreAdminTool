...
public class ServiceFactory {
    ...
    private HandlerServiceInterface createAdminClient() throws InternalClientException {
        final HandlerServiceInterface client = new AdminHandlerClient(serviceUri);
        client.setTransport(TransportProtocol.REST);
        return client;
    }
