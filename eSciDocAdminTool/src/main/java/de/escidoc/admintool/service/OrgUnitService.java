...
public class OrgUnitService {
    ...
    private TaskParam emptyFilter() {
        ...
        filters.add(getFilter(AppConstants.CREATED_BY_FILTER, AppConstants.SYSADMIN_OBJECT_ID, null));
    ...
    // FIXME duplicate method in ContextService
    private Filter getFilter(final String name, final String value, final Collection<String> ids) {
    ...
    public OrganizationalUnitList retrieveTopLevelOrgUnits() throws EscidocException, InternalClientException,
        TransportException {
        client.setTransport(TransportProtocol.REST);
        return client.retrieveOrganizationalUnits(createTaskParamWithTopLevelFilter());
    }
    ...
    public Collection<OrganizationalUnit> retrieveChildren(final String parentId) throws EscidocException,
        ...
        final OrganizationalUnitList childList = client.retrieveChildObjects(parentId);
